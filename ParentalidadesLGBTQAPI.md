...
- **Função Paterna e Materna**: As funções paterna e materna podem ser desempenhadas por qualquer figura de cuidado, independente de gênero ou orientação sexual. O importante é a introdução da lei e da ordem simbólica, garantindo a estruturação do sujeito.

#### Subjetivação e Identidade

- **Formação da Identidade**: A diversidade de experiências em parentalidades LGBTQIAP+ pode contribuir para a formação de identidades mais fluidas e inclusivas. A aceitação e valorização da diversidade é fundamental para a subjetivação saudável.

- **Resiliência e Resistência**: A experiência de parentalidades LGBTQIAP+ muitas vezes envolve resiliência e resistência contra normas discriminatórias, promovendo uma subjetivação que valoriza a diversidade e a inclusão.
